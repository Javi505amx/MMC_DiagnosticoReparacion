<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="_2._0_DiagnosticoReparacion.Default" %>
          ...
          <span class="h1 fw-bold mb-0">Login</span>
                        ...
                        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-4 pt-5 pt-xl-0 mt-xl-n5 " style="border-radius: 25px">
                            ...
                            <div runat="server" id="alert" visible="false" class=" d-flex align-items-center " role="alert">
                                ...
                                <h1 class=" text-center  fw-bold  texto  ">Diagnostico-Reparación</h1>
                                <img class="" src="Resources/images/inv.png" style="display: flex; text-align: center; max-width: 100%" /><br />
                   ...
                   <%--             <p class="small mb-5 pb-lg-2"><a class="text-muted" href="#!">Forgot password?</a></p>
                        ...
                        <footer class=" text-center  " style="position: fixed; bottom: 0; left: 9.5vw">
                            <p><b><%:DateTime.Now.Year%>  &copy; Designed for MMC Inventronics</b></p>
                        </footer>
                    </div>

                    <div class="col-sm-6 px-0 d-none d-sm-block ">
                        <img src="Resources/images/repair.png" alt="Login image" class="w-100 vh-100 bg " style="object-fit: cover; object-position: left;" />
